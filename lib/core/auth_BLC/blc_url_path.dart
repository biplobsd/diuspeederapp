class BlcPath {
  static const String baseUrl = 'https://elearn.daffodilvarsity.edu.bd';
  static const String apiLogin = '/login/token.php';
  static const String webLogin = '/login/index.php';
